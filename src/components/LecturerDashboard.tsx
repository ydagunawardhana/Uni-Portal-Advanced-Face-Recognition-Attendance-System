...
import { LogOut, User, UserCheck, Video } from 'lucide-react';
...
export default function LecturerDashboard({ onLogout }: LecturerDashboardProps) {
  ...
  const [attendanceLog, setAttendanceLog] = useState<AttendanceRecord[]>([
    ...
    { id: 2, studentName: 'Emily Johnson', indexNumber: 'CS/2021/002', timestamp: '09:15:45' },
    { id: 3, studentName: 'Michael Brown', indexNumber: 'CS/2021/003', timestamp: '09:16:12' },
    { id: 4, studentName: 'Sarah Davis', indexNumber: 'CS/2021/004', timestamp: '09:16:34' },
    { id: 5, studentName: 'David Wilson', indexNumber: 'CS/2021/005', timestamp: '09:17:01' },
  ]);
  ...
  useEffect(() => {
    ...
    const mockStudents = [
      { studentName: 'James Taylor', indexNumber: 'CS/2021/006', position: { top: '45%', left: '52%' } },
      { studentName: 'Emma Martinez', indexNumber: 'CS/2021/007', position: { top: '25%', left: '82%' } },
      { studentName: 'Oliver Anderson', indexNumber: 'CS/2021/008', position: { top: '70%', left: '40%' } },
      { studentName: 'Sophia Thomas', indexNumber: 'CS/2021/009', position: { top: '48%', left: '15%' } },
    ];
            ...
            <header className="bg-white shadow-sm border-b border-gray-200">
              <div className="px-8 py-4 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">{getHeaderDescription()}</p>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2 bg-gray-100 px-4 py-2 rounded-lg">
                    <User className="w-5 h-5 text-gray-600" />
                    <span className="text-sm font-medium text-gray-700">Dr. Johnson</span>
                  </div>
                  <button
                    onClick={onLogout}
        ...
        <div className="px-8 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-6">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">{getHeaderDescription()}</p>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 bg-gray-700 px-4 py-2 rounded-lg">
              ...
              <span className="text-sm font-medium text-gray-200">Dr. Johnson</span>
            </div>
            <button
              onClick={onLogout}
              className="flex items-center space-x-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors"
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 p-6">
          <div className="relative w-full h-full bg-gray-950 rounded-lg overflow-hidden border-2 border-gray-700">
            ...
            <div className="absolute top-4 right-4 bg-gray-800 bg-opacity-90 px-4 py-2 rounded-lg z-10">
              <p className="text-white text-sm font-medium">Session: 09:00 - 11:00</p>
            </div>
            ...
            {detectedFaces.map((face, index) => (
              ...
              >
                ...
                <div className="absolute -top-8 left-0 right-0 bg-green-500 px-2 py-1 rounded text-center">
                  <p className="text-white text-xs font-bold truncate">{face.name}</p>
                </div>
                {/* Checkmark Icon */}
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gray-800 bg-opacity-95 px-6 py-3 flex justify-between items-center">
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-300">Face Detection Active</span>
                </div>
                <span className="text-gray-500">|</span>
                <span className="text-sm text-gray-300">Detected: {detectedFaces.length} faces</span>
              </div>
        ...
        <div className="w-96 bg-gray-800 border-l border-gray-700 flex flex-col">
          <div className="p-6 border-b border-gray-700">
            <h2 className="text-xl font-bold text-white mb-2">Live Attendance Log</h2>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{record.indexNumber}</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-600">
                  <span className="text-xs text-gray-400">Detected at</span>
                  <span className="text-sm font-medium text-green-400">{record.timestamp}</span>
                </div>
              </div>
            ))}
          </div>
