  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/api/student/upload-profile-picture`,
        {
          method: "POST",
          headers: {
            ...
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
                ...
                <div className="inline-flex items-center gap-3 px-6 py-4 bg-green-100 border-2 border-green-500 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600">
                      Your face recognition is enabled
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> Face re-training requires admin
                  approval. You will be notified via notification once your
              ...
              <div className="space-y-5">
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-800 leading-relaxed">
                    ...
                    characters, include uppercase, lowercase, numbers, and
                    special characters.
                  </p>
                </div>
