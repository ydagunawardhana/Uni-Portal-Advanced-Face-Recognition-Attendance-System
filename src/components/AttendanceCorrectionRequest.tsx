    ...
    <div className="p-8 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-end mb-3">
                  ...
                  <div className="flex bg-red-100 rounded-full p-1 border-2 border-red-100">
                    <button
                      type="button"
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 border-2 border-gray-300 cursor-pointer rounded-xl font-semibold text-gray-900 bg-white focus:outline-none focus:ring focus:ring-red-500 focus:border-red-500 transition-all"
                  required
                >
                  <option value="">
                    {isLoadingSessions
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-xl font-semibold text-gray-900 bg-white focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 transition-all resize-none"
                  required
                />
              </div>
              ...
              <div>
                ...
                {evidenceFile ? (
                  ...
                  <div className="relative w-full rounded-xl border-2 border-dashed border-gray-500 bg-green-50 p-10 flex flex-col items-center justify-center animate-in fade-in zoom-in-95 duration-200">
                    <button
                      type="button"
                      onClick={() => setEvidenceFile(null)}
                      className="absolute top-4 right-4 w-8 h-8 font-bold flex items-center justify-center cursor-pointer rounded-full bg-red-100 text-red-500 hover:bg-red-100 hover:text-red-600 transition-colors shadow-sm cursor-pointer"
                      title="Remove file"
                    >
                      <X className="w-4 h-4" />
                    </button>

                    <div className="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center border border-green-200 shadow-sm mb-3">
                      <FileText className="w-8 h-8 text-green-600" />
                    </div>

                    <h4 className="text-gray-900 font-bold text-sm md:text-base mb-2 max-w-[80%] truncate text-center">
                      {evidenceFile.name}
                    </h4>

                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full border-2 border-green-200 bg-white text-sm font-bold text-green-700 mb-2 shadow-sm">
                  ...
                  <div className="relative border-2 border-dashed border-gray-300 bg-gray-100 rounded-xl p-12 flex flex-col items-center justify-center text-center hover:bg-gray-50 transition-colors bg-white">
                    <input
                      id="evidence-upload"
                      type="file"
        ...
        <div className="lg:col-span-1">
          <div
            className="bg-gray-50 rounded-xl border border-gray-200 shadow-md p-6 flex flex-col"
          ...
          >
            <div className="flex-shrink-0 mb-4 flex items-center justify-between">
              ...
              <button
                ...
                className="p-2 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-red-600 hover:border-red-200 transition-all shadow-sm text-sm font-semibold active:scale-95 disabled:opacity-50 cursor-pointer"
                ...
                pastRequests.map((request) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-700 font-semibold mt-2 pt-2 line-clamp-2 italic">
                        "{request.description}"
                      </p>
                      ...
                      {request.status === "Rejected" &&
                        request.rejection_reason && (
                          <div className="mt-4 bg-red-50 border-2 border-red-200 rounded-xl p-3 flex items-start gap-2 shadow-sm animate-in slide-in-from-top-1 duration-200">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl border border-gray-300 shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6">
              ...
              <p className="text-gray-700 text-sm mb-5 pl-13">
              ...
              <div className="flex justify-end gap-3">
                <button
                  ...
                  className="px-4 py-2 text-sm font-bold text-gray-700 border-2 border-gray-200 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
