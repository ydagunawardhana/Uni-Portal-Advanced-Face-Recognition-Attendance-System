    ...
    <div className="p-8 bg-white dark:bg-gray-800 min-h-full">
      ...
      <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-10 mb-8 border border-red-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">How can we help?</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6">Search for answers or browse help topics below</p>
          ...
          {faqCategories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2 text-lg">{category.title}</h3>
      ...
      <section>
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 border-2 border-gray-200 dark:border-gray-700">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Still need assistance?</h2>
            <p className="text-gray-600 dark:text-gray-400">Our support team is ready to help you</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700 hover:border-red-300 hover:shadow-md transition-all">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Response within 24 hours</p>
              <a
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700 hover:border-red-300 hover:shadow-md transition-all">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Student Hotline</h3>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Mon-Fri, 9 AM - 5 PM</p>
              <a
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700 hover:border-red-300 hover:shadow-md transition-all">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Visit Help Desk</h3>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Student Affairs Office</p>
